...
server: ${SERVER_DIR}server.o ${SERVER_DIR}server_util.o ${SERVER_DIR}file_transmission.o
	gcc ${LDFLAGS} ${SERVER_DIR}server.o ${SERVER_DIR}server_util.o ${SERVER_DIR}file_transmission.o -o s

${SERVER_DIR}server.o: ${SERVER_DIR}server.c ${SERVER_DIR}server_util.h ${SERVER_DIR}file_transmission.h
...
${SERVER_DIR}file_transmission.o : ${SERVER_DIR}file_transmission.c
	gcc ${CFLAGS} -c ${SERVER_DIR}file_transmission.c -o ${SERVER_DIR}file_transmission.o
